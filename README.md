# F5-XC-AZURE-VNET-HUB-SPOKE

This repository consists of Terraform templates to bring up a F5XC Azure Vnet Hub and Spoke environment.

## Usage

- Clone this repo with: `git clone --recurse-submodules https://github.com/cklewar/f5-xc-azure-vnet-hub-spoke`
- Enter repository directory with: `cd f5-xc-azure-vnet-hub-spoke`
